...
public class ArrayListProductDaoTest {
    ...
    public void getProduct() throws Exception {
        long numId = 1L;
        productDao.save(new Product(numId, "code1", "decription1", new BigDecimal(10), Currency.getInstance(Locale.US), 1));
    ...
    public void save() throws Exception {
        ...
        productDao.save(new Product(id, "code2", "decription2", new BigDecimal(10),Currency.getInstance(Locale.US), 1));
